...
import { BackgroundPickerModal, ProfileModal, GiftsModal, InvitesModal, CreateChatModal, StreamModal } from './components/Modals';
    ...
    const delaySearch = setTimeout(async () => {
        ...
        const resultsAsChats: Chat[] = foundUsers
            ...
            .map(u => {
                ...
                // Private chat ID convention: sort(uid1, uid2).join('_') or simply containing both
